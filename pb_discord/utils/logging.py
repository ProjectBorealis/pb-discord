...
"""
A :obj:`logging.Formatter` that can be used to standardise logging across all projects using pb_discord.
...
# Setup trace level logging so that we can use it within pb_discord.
